...
<span style={{ flex: 1 }} /><Link href="/dashboard" className="app-nav-link">Dashboard</Link><Link href="/pricing" className="app-nav-link">Bảng giá</Link>
</div>
</header>
...
className="btn-foil px-8 py-3 rounded-xl font-semibold text-base transition shadow-lg shadow-brand-500/20"
>
...
className="text-sm font-mono btn-foil px-4 py-1.5 rounded-full font-semibold transition">
...
className="btn-foil px-10 py-3.5 rounded-xl text-lg font-semibold transition shadow-lg shadow-brand-500/25">
...
<p className="text-navy-300 italic text-lg" style={{ fontFamily: 'var(--font-subhead)' }}>Mentor đang đọc bài của bạn…</p>
<div className="font-mono text-sm text-navy-500 mt-4 space-y-1.5">
{images.length > 0 && <p className="loading-line" style={{ animationDelay: '.3s' }}>Đang đọc ảnh bài viết tay…</p>}
<p className="loading-line" style={{ animationDelay: '1.2s' }}>Đang đọc mở bài của bạn…</p>
<p className="loading-line" style={{ animationDelay: '3s' }}>Đối chiếu band descriptor 4 tiêu chí…</p>
<p className="loading-line" style={{ animationDelay: '5.5s' }}>Đánh dấu từng lỗi ngữ pháp, từ vựng…</p>
<p className="loading-line" style={{ animationDelay: '8s' }}>Thảo nhận xét và bài mẫu Band 8.5+…</p>
</div>
</div>
)}
</main>
