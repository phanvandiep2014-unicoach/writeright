  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <main style={{ maxWidth: '720px', margin: '0 auto', padding: '60px 20px 80px' }}>
        <h1 style={{ fontFamily: 'var(--font-heading)', fontWeight: 400, fontSize: 28, color: 'var(--ivory)', marginBottom: 8 }}>
          Điều khoản dịch vụ
        </h1>
        ...
        <div style={{ fontFamily: 'var(--font-body)', fontSize: 16, color: '#cdbb8e', lineHeight: 1.8, display: 'flex', flexDirection: 'column', gap: 32 }}>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 400, fontSize: 18, color: 'var(--ivory)', marginBottom: 12 }}>2. Mô tả dịch vụ</h2>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 400, fontSize: 18, color: 'var(--ivory)', marginBottom: 12 }}>3. Tài khoản và đăng ký</h2>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 400, fontSize: 18, color: 'var(--ivory)', marginBottom: 12 }}>4. Gói dịch vụ và thanh toán</h2>
            <ul style={{ paddingLeft: 20, display: 'flex', flexDirection: 'column', gap: 6 }}>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 400, fontSize: 18, color: 'var(--ivory)', marginBottom: 12 }}>5. Quy tắc sử dụng</h2>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 400, fontSize: 18, color: 'var(--ivory)', marginBottom: 12 }}>6. Giới hạn trách nhiệm</h2>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 400, fontSize: 18, color: 'var(--ivory)', marginBottom: 12 }}>7. Sở hữu trí tuệ</h2>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 400, fontSize: 18, color: 'var(--ivory)', marginBottom: 12 }}>8. Thay đổi dịch vụ</h2>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 400, fontSize: 18, color: 'var(--ivory)', marginBottom: 12 }}>9. Liên hệ</h2>
