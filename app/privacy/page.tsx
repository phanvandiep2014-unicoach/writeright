    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <main style={{ maxWidth: '720px', margin: '0 auto', padding: '60px 20px 80px' }}>
        ...
        <div style={{ fontFamily: 'var(--font-body)', fontSize: 16, color: '#cdbb8e', lineHeight: 1.8, display: 'flex', flexDirection: 'column', gap: 32 }}>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 400, fontSize: 18, color: 'var(--ivory)', marginBottom: 12 }}>1. Thông tin chúng tôi thu thập</h2>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 400, fontSize: 18, color: 'var(--ivory)', marginBottom: 12 }}>2. Cách chúng tôi sử dụng thông tin</h2>
            <ul style={{ paddingLeft: 20, display: 'flex', flexDirection: 'column', gap: 6 }}>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 400, fontSize: 18, color: 'var(--ivory)', marginBottom: 12 }}>3. Bên thứ ba</h2>
            <ul style={{ paddingLeft: 20, display: 'flex', flexDirection: 'column', gap: 6 }}>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 400, fontSize: 18, color: 'var(--ivory)', marginBottom: 12 }}>4. Bảo mật dữ liệu</h2>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 400, fontSize: 18, color: 'var(--ivory)', marginBottom: 12 }}>5. Quyền của bạn</h2>
            <ul style={{ paddingLeft: 20, display: 'flex', flexDirection: 'column', gap: 6 }}>
